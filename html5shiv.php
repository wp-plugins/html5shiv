...
function rw_html5shiv() {
		...
		//wp_enqueue_script('html5shiv', plugins_url('/js/html5shiv.js', __FILE__), false, '3.6.2');
		
		// With Printshiv
		wp_deregister_script('html5shiv-printshiv'); // deregister
		wp_enqueue_script('html5shiv-printshiv', plugins_url('/js/html5shiv-printshiv.js', __FILE__), false, '3.6.2');
}
?>